...
return [
    ...
    'tour_par1' => 'GOTOLATAM offers the best Peru travel packages covering the main Peru destinations such as Machu Picchu, Rainbow Mountain, Cusco, Lima, Sacred Valley, Titicaca Lake, Puno, Arequipa, Nazca, the Amazon and many more. Our travel packages range from 2 days to 20 days.',
    ...
    'dest_title1' => 'South America Destinations',
    ...
    'info_par6' => 'GOTOLATAM is certified by the Peruvian Government, by the Ministry of Foreign Trade and Tourism of Peru (MINCETUR) . In addition we are also highly rated on Tripadvisor, Trustpilot and diverse well known travel forums.',
    ...
    'info_title2' => 'WHY CHOOSE GOTOLATAM',
    'info_subtitle5' => 'BOOK WITH CONFIDENCE',
    'info_par8' => 'Plan your trip risk-free with GOTOLATAM , enjoying flexible terms and peace of mind. Our deposits start as low as 20% . Terms & conditions apply.',
    'info_subtitle6' => 'TRUSTED LOCAL SOUTH AMERICA EXPERTS',
    'info_par9' => 'GOTOLATAM was established in 2010 and has been creating unforgettable tours in Peru ever since. Our travel consultants have extensive knowledge of our country as they are based in all destinations we operate and will use their expertise to craft your perfect trip to MachuPicchu. They will support you every step of the way, including authentic local 24/7 assistance.',
    'info_subtitle7' => 'GREAT TESTIMONIALS',
    'info_par10' => 'GOTOLATAM is committed to the best service, and this is reflected year after year when Tripadvisor awards us with their Certificate of Excellence. In addition we take pride of our customer feedback: 97% of our travellers say they would recommend us to family and friends.',
    'info_subtitle8' => 'STRESS-FREE EXPERIENCE',
    'info_par11' => 'We handle all the details of planning an unforgettable vacation to Peru. We take care of organising everything for you, our agent will be there since your arrival and at every point of service, so you save time and effort. You can look forward and enjoy your Peru trip knowing that GOTOLATAM have everything in hand.',
    ...
    'info_par13' => 'Our GOTOLATAM representatives personally handpick every hotel included in your itinerary, ensuring that each one meets our high standards when it comes to service, quality, location and character. Having a comfortable and friendly place to rest after a day of exploring is super important and part of your peruvian experiences.',
    ...
    'confi_par2' => 'These measures have been developed in alignment with government recommendations and health providers across our destinations. For example, GOTOLATAM has implemented the World Travel & Tourism Council’s “Safe Travels” protocols and the Peruvian Tourist Board’s “Clean & Safe” norms.',
    ...
    'confi_par4' => 'Our GOTOLATAM travel agents select the hotels for their quality, location and high service standards. In addition, we are working with our hotel partners to ensure that they also meet our health and hygiene requirements.',
    ...
    'confi_par8' => 'GOTOLATAM best local guides. They will be there to keep you safe and create an unforgettable Peru vacation from start to finish.',
    ...
    'confi_par10' => 'Part of the GOTOLATAM experience will be to have all comprehensiva travel documents and useful information before arrival and in addition your travel advisor will keep you updated should any changes arise.',
    ...
    'confi_par13' => 'Our Headquarters are located in Cusco but we have remote offices in Arequipa, Lima and Puno, plus GOTOLATAM representatives in MachuPicchu, Nazca, Paracas, Urubamba, Puerto Maldonado and Chiclayo.',

    'book_title1' => 'BOOKING TERMS',
    'book_title2' => 'BOOKING TERMS AND CONDITIONS',
    'book_subtitle1' => 'BOOKING CONDITIONS',
    'book_par1' => 'GOTOLATAM is the online booking site and trading name of GOTOLATAM GROUP SAC. Our registered headquarters are at El Sol Avenue 449 - Cusco - Cusco . Registration no. 000873-005733 from the Ministry of Foreign Trade and Tourism of Peru or MINCETUR. And Peru Tax Authorization RUC : 205619753',
    'book_par2' => "Any booking made by a customer, whether through the company's website or otherwise, shall be deemed an offer by the customer to purchase the relevant package or travel arrangement subject to these booking conditions. By submitting a booking, you warrant and confirm to us that you comply with these arrangements. No contract between the customer and GOTOLATAM shall come into existence until GOTOLATAM receives the initial deposit payment and issues a Payment Receipt. The customer making the booking accepts these conditions on behalf of all members of their travel party and is responsible for payment balance from the party in entirety.",
    'book_par3' => 'Booking services with GOTOLATAM are only available to persons who are at least 18 years old. Additionally, individuals under the age of 18 on a GOTOLATAM tour must be accompanied by an adult.',
    ...
    'book_par5' => 'Accepted payment methods: GOTOLATAM accepts all major credit and debit cards, and for bookings made at least 10 days before the travel date, we also accept bank wires.',
    'book_par6' => 'We accept payments from: Visa, Visa Electron, MasterCard, Maestro, JCB, Discover, UnionPay, Diners, and American Express cards.If you wish to pay via bank transfer/wire, please select "Bank Transfer" as your payment method in the booking process, and GOTOLATAM will send our bank information. Please note that bank wires are not possible for bookings made less than 10 days from the date of travel.',
    'book_par7' => 'Payments: GOTOLATAM will require an initial deposit payment , depending of the program could be 20% - 30% - 50% or the full amount at the time of booking, depending on when the booking is made, your destination, number of travellers, and what type of tour package is booked.',
    'book_par8' => 'Payment processing: Once payment has been received, your travel advisor will send you a payment receipt.',
    'book_par9' => 'Delayed payments: GOTOLATAM reserves the right to treat cases of delayed payment as a cancellation of the booking, and the company can withdraw its confirmation of services. Please note that this applies if no agreement has been made for paying the remaining balance.',

    'abou_title1' => 'About',
    'abou_title2' => 'YOUR LOCAL PERU TRAVEL EXPERTS',
    'abou_par1' => 'GOTOLATAM is a specialist travel agency catering to travellers who want an original, authentic and unforgettable experience at the land of the Incas.',
