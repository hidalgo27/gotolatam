...
<body class="bg-white dark:bg-gray-800 dark:text-gray-400 relative">
    ...
    {{--        <a href="https://api.whatsapp.com/send?phone=51934005414" target="_blank"> --}}
    ...
    <div x-data="{ menu: false }">
        <div class="fixed bg-12 bottom-0 w-full z-30 sm:hidden">
            ...
            <a href="#form-dream-adventure"
                class="btn-primary text-center w-full block">{{ __('message.button_book') }}</a>
            <div
            ...
            @foreach ($nav_links as $nav_link)
                @if ($nav_link['nav_sub_links'])
                    <span @click="menu2 = !menu2"
                        class="w-full text-sm flex inline-flex transition-colors duration-200 block px-4 py-2 text-normal text-gray-900 rounded hover:bg-gray-700 hover:text-secondary menu-pop  {{ $nav_link['active'] == 1 ? 'active' : '' }}">
                        <span class="mr-2">
                            {!! $nav_link['icon'] !!}
                        </span>
                        {{ $nav_link['name'] }}
...
{{--                    class="h-10 w-10 flex justify-center items-center focus:outline-none text-gray-500">--}}
...
{{--                </button>--}}
                ...
                <a href="#form-dream-adventure"
                    class="btn-secondary text-center">{{ __('message.button_inquire') }}</a>
        ...
        <div class="banner">
            ...
            <div class="bg-gray-50 opacity-90 shadow-lg dark:bg-gray-800 hidden md:inline-flex">
                <div class="container flex items-center justify-center mx-auto text-gray-600 capitalize relative"
                    ...
                    <span @click="menu2 = !menu2"
                        class="dark:text-gray-400 flex items-center menu-list block cursor-pointer {{ $nav_link['active'] == 1 ? 'active' : '' }}">
                        By Country
                    ...
                    @foreach ($nav_links as $nav_link)
                        @if ($nav_link['state'] > 1)
                            <div class="relative">
                                ...
                                @else
                                    <a href="{{ $nav_link['route'] }}"
                                        class="dark:text-gray-400 menu-list block relative {{ $nav_link['active'] == 1 ? 'active' : '' }}">
            ...
            <div class="grid grid-cols-2 gap-4 dark:text-gray-300 md:grid-cols-5 mb-24">
                ...
                <div>
                    ...
                    <ul class="mt-2 space-y-2">
                        <li>
                            <a href="{{ route('book') }}"
                                class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">{{ __('message.nav_sub_item1') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('confidence') }}"
                                class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">{{ __('message.nav_sub_item2') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('conditions') }}"
                                class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">{{ __('message.nav_sub_item3') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('about') }}"
                                class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">{{ __('message.nav_sub_item4') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('faq') }}"
                                class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">{{ __('message.nav_sub_item6') }}</a>
                        </li>
                    </ul>
                </div>
                <div>
